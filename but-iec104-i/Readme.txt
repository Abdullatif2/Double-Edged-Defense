...
For description, see P. Matoušek, V. Havlena, and L. Holík, “Efficient Modelling of ICS Communication For Anomaly Detection Using Probabilistic Automata,” in 2021 IFIP/IEEE International Symposium on Integrated Network Management (IM), 2021, pp. 81–89.
...
Format: 
Each line contains a list of headers of interest extracted from the IEC 104 packet. The fields are as follows: 
   ...
   - Originator address
   - ASDU address field
   - Information Object Address: a list of addresses of Information Objects present in the ASDU
